                ...
                <nav class="classy-navbar justify-content-between" id="conferNav">
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            ...
                            <!-- Get Tickets Button -->
                            <a href="tickets.html" class="btn confer-btn mt-3 mt-lg-0 ml-3 ml-lg-5">Get Tickets</i></a>
                        </div>
                        <!-- Nav End -->
                    </div>
                </nav>
...
<div class="row">
                ...
                <div class="col-12">
                    <div class="more-speaker-btn text-center mt-20 mb-40 wow fadeInUp" data-wow-delay="300ms">
                        <a class="btn confer-btn-white" href="speakers.html">view all Speaker </i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-60">
                            ...
                            <p>If you want to know about our Confarence.Please visit our page and connect us. </p>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-60">
                            ...
                            <div class="footer-contact-info">
                                <p><i class="zmdi zmdi-map"></i> Dhaka,Bangladesh</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Naima</a>
