...
<center>
<div id="d">
<img src="Reg/reg.png" class="img"></img>
...
<a href="Reg/login.php"><input name="back" type="button" id="button" value="BACK TO SIGN-IN">
</input>
...
if(isset($_POST['signup'])){
	...
	$insertion= "insert into users values('$name','$email','$number','$pass')";
