                ...
                <nav class="classy-navbar justify-content-between" id="conferNav">
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            ...
                            <!-- Get Tickets Button -->
                            <a href="tickets.php" class="btn confer-btn mt-3 mt-lg-0 ml-3 ml-lg-5">Get Tickets</i></a>
                        </div>
                        <!-- Nav End -->
                    </div>
                </nav>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                                            ...
                                            <!-- Schedule Btn -->
                                            <a href="speakers.php" class="btn confer-btn">View More </i></a>
                                        </div>
