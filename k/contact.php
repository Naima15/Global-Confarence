...
=                                <li class="active"><a href="index.html">Home</a></li>
                            ...
                            <!-- Get Tickets Button -->
                            <a href="#" class="btn confer-btn mt-3 mt-lg-0 ml-3 ml-lg-5">Get Tickets</i></a>
                        </div>
                        <!-- Nav End -->
                    </div>
                </nav>
                ...
                <div class="col-12 col-lg-6">
                    <div class="contact_from_area mb-100 clearfix">
                        ...
                        <div class="contact-heading">
                            <h4>Contact us</h4>
                            <p>Please visit our frequently asked questions if you have a query about conference. If your question is not answered, please use the list below to contact us.</p>
                        </div>
    ...
    <!-- Map Area -->
    <div class="map-area">
	<a href="https://www.google.com/maps/@23.7508354,90.3911565,17z"></a>
		<!--
