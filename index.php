                ...
                <nav class="classy-navbar justify-content-between" id="conferNav">
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            ...
                            <!-- Get Tickets Button -->
                            <a href="register.php" class="btn confer-btn mt-3 mt-lg-0 ml-3 ml-lg-5">Registration</a>
                        ...
                        <div class="col-12">
                            <div class="welcome-text text-right">
                                ...
                                <div class="hero-btn-group" data-animation="fadeInUp" data-delay="700ms">
                                    <a href="contact.php" class="btn confer-btn">More Information</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12">
                            <div class="welcome-text-two text-center">
                                ...
                                <div class="hero-btn-group" data-animation="fadeInUp" data-delay="700ms">
                                    <a href="schedule.php" class="btn confer-btn m-2">View more</i></a>
                                    <a href="ticket.php" class="btn confer-btn m-2">Get Tickets </i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="about-content-text mb-80">
                        ...
                        <a href="schedule.php" class="btn confer-btn mt-50 wow fadeInUp" data-wow-delay="300ms">Interested </i></a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="social-info">
                            ...
                            <a href="https://www.linkedin.com/"><i class="zmdi zmdi-linkedin"></i></a>
                        </div>
                        <!-- Info -->
                        <div class="speaker-info">
                            <h5>Professor Dr. Touhid Bhuiyan</h5>
                            <p>Professor & Head</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <!-- Info -->
                        <div class="speaker-info">
                            <h5>Dr. Imran Mahmud</h5>
                            <p>Associate Professor & Head <br /> (Dept. ITM )</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <!-- Info -->
                        <div class="speaker-info">
                            <h5>Kaushik Sarker</h5>
                            <p>Assistant Professor & Associate Head</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <!-- Info -->
                        <div class="speaker-info">
                            <h5>Mr. Khalid Been Badruzzaman Biplob</h5>
                            <p>Lecturer</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="more-speaker-btn text-center mt-20 mb-40 wow fadeInUp" data-wow-delay="300ms">
                        <a class="btn confer-btn-white" href="speakers.php">view all Speaker </i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="schedule-tab">
                        ...
                        <ul class="nav nav-tabs wow fadeInUp" data-wow-delay="300ms" id="conferScheduleTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="monday-tab" data-toggle="tab" href="#step-one" role="tab" aria-controls="step-one" aria-expanded="true">Monday <br> <span>January 14, 2021</span></a>
                            </li>
                            <!-- Nav Item -->
                            <li class="nav-item">
                                <a class="nav-link" id="tuesday-tab" data-toggle="tab" href="#step-two" role="tab" aria-controls="step-two" aria-expanded="true">Tuesday <br> <span>January 15, 2021</span></a>
                            </li>
                            <!-- Nav Item -->
                            <li class="nav-item">
                                <a class="nav-link" id="wednesday-tab" data-toggle="tab" href="#step-three" role="tab" aria-controls="step-three" aria-expanded="true">Wednesday <br> <span>January 16, 2021</span></a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                                            ...
                                            <div class="single-schedule-tumb-info d-flex align-items-center">
                                                ...
                                                <div class="single-schedule-info">
                                                    ...
                                                    <p>by <span>Jannatun Naima</span> / Ceo of GC</p>
                                                </div>
                                            </div>
                                            <!-- Single Schedule Info -->
                                            <div class="schedule-time-place">
                                                <p><i class="zmdi zmdi-time"></i> 12-14 Jan 2021</p>
                                                <p><i class="zmdi zmdi-map"></i> BICC, Dhaka</p>
                                            </div>
                                            <!-- Schedule Btn -->
                                            <a href="schedule.php" class="btn confer-btn">View More </i></a>
                                        </div>
                                        ...
                                        <div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                                            ...
                                            <div class="single-schedule-tumb-info d-flex align-items-center">
                                                ...
                                                <div class="single-schedule-info">
                                                    ...
                                                    <p>by <span>Hasnur Jahan</span> / Ceo of GC</p>
                                                </div>
                                            </div>
                                            <!-- Single Schedule Info -->
                                            <div class="schedule-time-place">
                                        ...
                                        <div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                                            ...
                                            <div class="single-schedule-tumb-info d-flex align-items-center">
                                                ...
                                                <div class="single-schedule-info">
                                                    ...
                                                    <p>by <span>Martha Burke</span> / Ceo of GC</p>
                                                </div>
                                            </div>
                                            <!-- Single Schedule Info -->
                                            <div class="schedule-time-place">
                                        ...
                                        <div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                                            ...
                                            <div class="single-schedule-tumb-info d-flex align-items-center">
                                                ...
                                                <div class="single-schedule-info">
                                                    ...
                                                    <p>by <span>Jeffrey Morales</span> / Ceo of GC</p>
                                                </div>
                                            </div>
                                            <!-- Single Schedule Info -->
                                            <div class="schedule-time-place">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                                            ...
                                            <div class="single-schedule-tumb-info d-flex align-items-center">
                                                ...
                                                <div class="single-schedule-info">
                                                    <h6>Crop Insurance Conference</h6>
                                                    <p>by <span>Amanda Hudson</span> / Ceo of GC</p>
                                                </div>
                                            </div>
                                            <!-- Single Schedule Info -->
                                            <div class="schedule-time-place">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                                            ...
                                            <div class="single-schedule-tumb-info d-flex align-items-center">
                                                ...
                                                <div class="single-schedule-info">
                                                    <h6>Dealing with Difficult People</h6>
                                                    <p>by <span>Gary Armstrong</span> / Ceo of GC</p>
                                                </div>
                                            </div>
                                            <!-- Single Schedule Info -->
                                            <div class="schedule-time-place">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-ticket-pricing-table text-center mb-100 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <a href="tickets.php" class="btn confer-btn w-100 mb-30">Get Tickets </i></a>
            ...
            <div class="row justify-content-between">
                <div class="col-12 col-sm-3">
                    <div class="contact-information mb-100">
                        ...
                        <div class="single-contact-info wow fadeInUp" data-wow-delay="300ms">
                            <p>Email:</p>
                            <h6>conference@gmail.com</h6>
                        </div>
                        <!-- Single Contact Info -->
                        <div class="single-contact-info wow fadeInUp" data-wow-delay="300ms">
                            <p>Website:</p>
                            <h6>www.conference.com</h6>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-60 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="footer-contact-info">
                                <p><i class="zmdi zmdi-map"></i> Dhanmondi 32,Dhaka</p>
